...
def cube_voxel_centers(resolution):
    '''returns an array of (x,y,z) coordinates in 0-1 representing centers of voxel cells
    ...
    '''
    x = np.linspace(0+1/(resolution*2), 1-1/(resolution*2), resolution)
    y=x
    z=x
    xx, yy, zz = np.meshgrid(x, y, z)
